...
const ROOM_SPOTLIGHTS = [
  {
    title: 'The Open Scandinavian Living & Dining',
    specs: '3BHK Apartment · 1,650 sq.ft',
    timeline: '42 Days',
    desc: 'Light-filled space featuring fluted wall accents, warm oak laminates, profile lighting, and concealed bar unit.',
    img: '/images/stock/a151a9e5.webp',
  },
  {
    title: 'The Parallel Modular Chef’s Kitchen',
    specs: 'Villa Kitchen · 220 sq.ft',
    timeline: '18 Days',
    desc: 'Matte acrylic finish with Blum Aventos lift-ups, quartz countertops, tandem pull-outs, and built-in appliance garage.',
        ...
        <div className="max-w-[1240px] mx-auto text-center">
          <Reveal>
            ...
            <h1 className="font-[family-name:var(--font-bricolage)] font-bold text-[clamp(34px,4.6vw,58px)] leading-[1.06] tracking-[-0.02em] max-w-[780px] mx-auto">
              Real delivered homes by <mark className="bg-[linear-gradient(transparent_62%,#fdeecb_62%)] text-[#0e5a43] px-0.5">{cleanName || 'our studio'}</mark>
            </h1>
            <p className="mt-5 max-w-[580px] mx-auto text-[#6b6660] text-[16.5px] leading-[1.7] font-medium">
              {cleanDesc || `Browse real homes designed and delivered across ${city}. High-precision joinery, smart storage, and warm Nordic aesthetics.`}
            </p>
          </Reveal>
        </div>
      </section>
