  ...
  return (
    <div className="font-sans text-slate-200 bg-[#0B0F19] min-h-screen selection:bg-[#38BDF8] selection:text-slate-900 scroll-smooth">
      ...
      <section className="py-24 bg-slate-950/40 border-b border-white/5 relative">
        <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-[#06B6D4]/5 rounded-none blur-[100px] pointer-events-none rotate-12"></div>
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="flex flex-col p-6 rounded-none bg-slate-950/80 border border-slate-700/60 backdrop-blur-md hover:border-[#38BDF8]/50 transition-all shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
                <div className="w-12 h-12 rounded-none bg-slate-900/90 border border-slate-700/60 flex items-center justify-center mb-6 text-[#38BDF8]">
      ...
      <section id="services" className="py-24 bg-[#0B0F19] border-b border-white/10 relative">
        <div className="absolute top-1/4 left-1/4 w-80 h-80 bg-[#6366F1]/5 rounded-none blur-[100px] pointer-events-none -rotate-12"></div>
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          <div className="mb-16 space-y-4">
            <div className="flex flex-col">
              <h2 className={`${plusJakarta.className} text-4xl md:text-5xl font-extrabold text-white`}>Sleek Interior</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {servicesList.map((svc: string, i: number) => {
              ...
              return (
                <div key={i} className="group bg-slate-950/80 backdrop-blur-md p-8 rounded-none border border-slate-700/60 hover:border-[#38BDF8]/50 transition-all flex flex-col justify-between min-h-[300px] shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
                  <div className="mb-6 aspect-4/3 overflow-hidden rounded-none bg-slate-900/90 border border-slate-700/60">
                  ...
                  <div>
                    <div className="mb-6 w-10 h-10 rounded-none bg-slate-900/90 border border-slate-700/60 flex items-center justify-center text-[#38BDF8]">
      ...
      <section id="about" className="py-24 bg-slate-950/40 border-b border-white/5 relative">
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#06B6D4]/5 rounded-none blur-[100px] pointer-events-none rotate-12"></div>
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative p-2 bg-slate-950/80 border border-slate-700/60 rounded-none backdrop-blur-md shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
              <img src={doctorImage} alt={doctor.name || "Lead designer"} className="w-full aspect-4/5 object-cover rounded-none" />
              <div className="absolute -bottom-6 -right-4 bg-slate-950/95 backdrop-blur-md p-6 rounded-none border border-slate-700/60 flex items-center gap-6 shadow-2xl">
                <div>
                  <h3 className={`${plusJakarta.className} text-base font-bold text-white`}>{doctor.name || 'Lead Designer'}</h3>
                  <p className="text-[10px] text-[#38BDF8] uppercase tracking-wider mt-1 font-semibold">{doctor.specialization || 'Interior Designer'}</p>
                </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 pt-4">
                <div className="flex gap-4">
                  <div className="mt-1 w-8 h-8 rounded-none bg-slate-900/90 border border-slate-700/60 flex items-center justify-center text-[#38BDF8] shrink-0"><Ruler className="w-4 h-4" /></div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="mt-1 w-8 h-8 rounded-none bg-slate-900/90 border border-slate-700/60 flex items-center justify-center text-[#38BDF8] shrink-0"><Palette className="w-4 h-4" /></div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="mt-1 w-8 h-8 rounded-none bg-slate-900/90 border border-slate-700/60 flex items-center justify-center text-[#38BDF8] shrink-0"><Hammer className="w-4 h-4" /></div>
                  <div>
      ...
      <section id="gallery" className="py-24 bg-[#0B0F19] border-b border-white/10 relative">
        <div className="absolute top-1/3 left-1/3 w-80 h-80 bg-[#6366F1]/5 rounded-none blur-[100px] pointer-events-none -rotate-12"></div>
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          <div className="mb-16 space-y-4">
            <div className="flex flex-col">
              <h2 className={`${plusJakarta.className} text-4xl md:text-5xl font-extrabold text-white`}>Project Showcase</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {allGalleryImages.length > 0 ? (
              allGalleryImages.map((img: string, idx: number) => (
                <div key={idx} className="group cursor-pointer flex flex-col h-full bg-slate-950/80 p-4 rounded-none border border-slate-700/60 hover:border-white/20 transition-all shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
                  <div className="aspect-4/3 bg-slate-900 rounded-none overflow-hidden relative mb-4">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="flex flex-col items-center justify-center bg-white text-slate-900 w-12 h-12 rounded-none shadow-lg transform group-hover:scale-110 transition-all">
              ...
              INTERIOR_GALLERY_PREVIEW.map((item, idx) => (
                <div key={idx} className="group cursor-pointer flex flex-col h-full bg-slate-950/80 p-4 rounded-none border border-slate-700/60 transition-all shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
                  <div className="aspect-4/3 bg-slate-900 rounded-none overflow-hidden relative mb-4">
      ...
      <section className="py-24 bg-[#0B0F19] border-b border-white/10 relative">
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          <div className="mb-16 space-y-4 text-center flex flex-col items-center">
            ...
            <p className="text-base text-slate-400 max-w-lg font-light">Read direct feedback from homeowner handovers.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {displayReviews.map((review: any, i: number) => (
              <div key={i} className="bg-slate-950/80 backdrop-blur-md p-8 rounded-none border border-slate-700/60 flex flex-col h-full justify-between hover:border-[#38BDF8]/30 transition-all shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
                <div>
                ...
                <div className="flex items-center gap-3 mt-6 border-t border-white/10 pt-4">
                  <div className="w-8 h-8 bg-slate-900/90 rounded-none border border-slate-700/60 flex items-center justify-center text-white font-bold text-xs">
      ...
      <section className="py-24 bg-slate-950/40 border-b border-white/5">
        <div className="max-w-4xl mx-auto px-8 w-full">
          ...
          <div className="space-y-3">
            {faqs.map((faq, idx) => (
              <details key={idx} className="group border border-slate-700/60 rounded-none bg-slate-950/80 px-6 py-2 open:bg-slate-950/80 transition-all">
      ...
      <section className="py-24 bg-slate-950 text-white">
        <div className="max-w-6xl mx-auto px-8 w-full grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-none bg-slate-900/90 border border-slate-700/60 flex items-center justify-center text-[#38BDF8]">
          ...
          <div className="bg-slate-950/80 border border-slate-700/60 backdrop-blur-md rounded-none p-8 lg:p-10 shadow-2xl">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input type="text" placeholder="John Doe" className="w-full bg-slate-900/80 border border-slate-700/60 rounded-none px-4 py-2.5 text-white placeholder-slate-600 focus:outline-none focus:border-[#38BDF8]" />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Phone</label>
                <input type="tel" placeholder="+1 (555) 000-0000" className="w-full bg-slate-900/80 border border-slate-700/60 rounded-none px-4 py-2.5 text-white placeholder-slate-600 focus:outline-none focus:border-[#38BDF8]" />
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-400 uppercase mb-2">Message</label>
                <textarea rows={3} placeholder="Describe your room configurations..." className="w-full bg-slate-900/80 border border-slate-700/60 rounded-none px-4 py-2.5 text-white placeholder-slate-600 focus:outline-none focus:border-[#38BDF8] resize-none"></textarea>
              </div>
              <button type="button" className="w-full bg-white text-slate-900 font-bold py-3 rounded-none transition-all hover:scale-[1.02] active:scale-[0.98]">
                Submit Request
              </button>
            </form>
          </div>
