...
const testimonials = [
  {
    id: 'REC-001',
    text: "I hired this atelier for my full villa construction. It was a wonderful experience from the first soil test to the final keys handover. The architectural team was always polite and precise. They honoured the frozen BOQ exactly, and I am really satisfied with the final build.",
    author: "Sanjeev V",
    treatment: "Turnkey Villa Construction",
    rating: 5
  },
  {
    id: 'REC-002',
    text: "One of the top architects and civil builders in Chennai. They explained the soil condition, FSI, setbacks, and what we should do now versus later. The structural engineering and site supervision were professional throughout.",
    author: "Victor D",
    treatment: "Structural & Civil Turnkey",
    rating: 5
  },
  {
    id: 'REC-003',
    text: "My family recently completed a full independent house with this team, and we couldn't be happier. From CMDA sanction filing to monolithic RCC casting and the final facade, every step was handled with exceptional care and professionalism.",
    author: "Arumuga Nainar",
    treatment: "Independent Residence",
    rating: 5
  },
  {
    id: 'REC-004',
    text: "This is one of the best architecture practices in Chennai. I went in with a lot of doubts about coastal soil and budget overruns, but everything was better than expected. The principal architect explained each step clearly and the site stayed on schedule.",
    author: "Christy Elsie",
    treatment: "Residential Architecture",
    rating: 5
  }
];
        ...
        <div className="cta-container text-center max-w-3xl mx-auto py-12 px-6 rounded-3xl glass-card border border-white/40 shadow-xl relative overflow-hidden group">
           ...
           <div className="relative z-10">
              ...
              <p className="text-lg text-[var(--muted)] mb-10 max-w-xl mx-auto leading-relaxed">
                Speak with our architectural team and get a clear project plan with transparent pricing—focused on design clarity, structural functionality, and long‑term durability.
              </p>
