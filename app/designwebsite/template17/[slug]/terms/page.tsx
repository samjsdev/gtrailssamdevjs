...
export const metadata: Metadata = {
  title: 'Terms of Service - Architectural Atelier',
  description: 'Terms of Service for using the Architectural Atelier website and services.',
  robots: {
    index: false,
    follow: true,
  },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-[var(--muted)]">
          <section>
            ...
            <p>
              Welcome to Architectural Atelier. By accessing our website and using our services, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The content provided on this website is for informational purposes only and is not intended to be a substitute for professional architectural or structural engineering advice. Always seek the advice of a qualified architect or licensed structural engineer with any questions you may have regarding your project. Never disregard professional advice or delay in seeking it because of something you have read on this website.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All content on this website, including text, graphics, logos, images, and software, is the property of Architectural Atelier or its content suppliers and is protected by international copyright laws. You may not reproduce, distribute, modify, or create derivative works of any content without our express written consent.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Architectural Atelier shall not be liable for any direct, indirect, incidental, special, or consequential damages that result from the use of, or the inability to use, the materials on this site or the performance of the products, even if Architectural Atelier has been advised of the possibility of such damages.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4">
              <p><strong>Architectural Atelier</strong></p>
              <p>Chennai, Tamil Nadu</p>
              <p>Email: contact@architecturalatelier.in</p>
              <p>Phone: +91 97513 96117</p>
            </div>
          </section>
        </div>
      </div>
