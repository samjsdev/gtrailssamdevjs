...
export default async function Template5ContactPage({ params }: PageProps) {
  ...
  return (
    <div className="w-full bg-[#F8F7F4] text-[#1E2322]">
      {/* ─── Hero Banner Section ─── */}
      <section id="contact-hero" className="relative py-20 sm:py-28 bg-white border-b border-[#1E2322]/15">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="max-w-3xl space-y-4">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold uppercase text-[#1E2322] tracking-tight leading-[0.95]">
              GET IN TOUCH WITH OUR <span className="text-[#C85A32]">ENGINEERING STUDIO</span>
            </h1>
      ...
      <section className="py-24 px-4 sm:px-8 bg-[#F8F7F4] border-b border-[#1E2322]/15">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono">
            <div className="bg-white p-6 border border-[#1E2322]/15 rounded-sm shadow-sm hover:shadow-md hover:border-[#C85A32]/40 transition-all space-y-3">
              <div className="w-10 h-10 bg-[#C85A32] text-white flex items-center justify-center rounded-sm shadow-sm">
                <Phone className="w-5 h-5" />
              </div>
              <span className="text-[10px] font-semibold uppercase tracking-widest text-[#C49B45] block">
                DIRECT TELEPHONE
              </span>
              <a href={`tel:${clinicPhone.replace(/[^0-9+]/g, '')}`} className="text-base font-bold text-[#1E2322] block hover:text-[#C85A32] transition-colors">
                {clinicPhone}
              </a>
              <span className="text-[11px] text-[#1E2322]/70 block font-sans">
                Mon - Sat: 09:00 AM - 07:30 PM
              </span>
            </div>

            <div className="bg-white p-6 border border-[#1E2322]/15 rounded-sm shadow-sm hover:shadow-md hover:border-[#C85A32]/40 transition-all space-y-3">
              <div className="w-10 h-10 bg-[#181C1B] text-[#C49B45] flex items-center justify-center rounded-sm shadow-sm">
                <Mail className="w-5 h-5" />
              </div>
              <span className="text-[10px] font-semibold uppercase tracking-widest text-[#C49B45] block">
                OFFICIAL INQUIRIES
              </span>
              <a href={`mailto:${clinicEmail}`} className="text-base font-bold text-[#1E2322] block hover:text-[#C85A32] transition-colors truncate">
                {clinicEmail}
              </a>
              <span className="text-[11px] text-[#1E2322]/70 block font-sans">
            ...
            <div className="bg-white p-6 border border-[#1E2322]/15 rounded-sm shadow-sm hover:shadow-md hover:border-[#C85A32]/40 transition-all space-y-3">
              <div className="w-10 h-10 bg-[#181C1B] text-[#C85A32] flex items-center justify-center rounded-sm shadow-sm">
                <MapPin className="w-5 h-5" />
              </div>
              <span className="text-[10px] font-semibold uppercase tracking-widest text-[#C49B45] block">
                HEAD OFFICE & STUDIO
              </span>
              <p className="text-xs text-[#1E2322] font-semibold leading-relaxed">
                {clinicAddress}
              </p>
            </div>
          </div>
      ...
      <section className="py-24 px-4 sm:px-8 bg-white border-b border-[#1E2322]/15">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="bg-[#F8F7F4] p-6 border border-[#1E2322]/15 rounded-sm shadow-sm space-y-2 hover:shadow-md transition-all"
              >
                <div className="flex items-start gap-3">
                  <span className="font-mono text-sm font-bold text-[#C85A32] mt-0.5">0{idx + 1}.</span>
                  <h4 className="text-base font-bold uppercase text-[#1E2322] tracking-tight">
                    {faq.q}
                  </h4>
                </div>
                <p className="text-xs sm:text-sm text-[#1E2322]/80 font-sans leading-relaxed pl-7">
                  {faq.a}
                </p>
              </div>
            ))}
