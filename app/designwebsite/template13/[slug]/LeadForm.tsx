  ...
  return (
    <div className="bg-white text-[#241f1a] rounded-[20px] px-7 py-8 shadow-[0_34px_70px_-20px_rgba(0,0,0,0.5)] w-full">
      ...
      <p className="text-[13.5px] text-[#6d6259] mb-5">
        Includes site visit, 3D massing &amp; itemised civil quote.
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
          ...
          >
            ...
            <option>Turnkey Residential Villa (G+1 / G+2)</option>
            <option>Independent Duplex on Plot</option>
            <option>Architectural Plan &amp; 3D BIM Walkthrough</option>
            <option>CMDA / DTCP Sanction Approvals</option>
            <option>Structural Engineering &amp; Soil Test</option>
            <option>Major Renovation &amp; Floor Addition</option>
          </select>
          <input
            name="locality"
            type="text"
            placeholder={`Plot locality in ${city} (e.g. ECR, Anna Nagar)`}
            aria-label="Locality"
        ...
        >
          {sent ? "Booked! We'll call you soon ✓" : 'Consult Architects →'}
        </button>
      </form>
      <p className="text-[11.5px] text-[#6d6259] text-center mt-3">
        A licensed architect or senior civil engineer calls within 24 hours.
      </p>
    </div>
  );
}
