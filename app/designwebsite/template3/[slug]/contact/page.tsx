...
const CONSULTATION_PROCESS = [
  { step: '1', title: 'Quick Callback', time: 'Under 2 Hours', desc: 'Our team contacts you to discuss floor plan details and move-in timeline.' },
  { step: '2', title: 'Studio / Site Meeting', time: '45 Minutes', desc: 'Meet your interior designer, touch material samples, and explore 3D layout ideas.' },
  { step: '3', title: 'Itemised 3D & BOQ', time: '3 – 5 Days', desc: 'Receive photorealistic room views with an exact, frozen bill of quantities.' },
  { step: '4', title: '45-Day Handover', time: 'On Schedule', desc: 'Parallel factory production and on-site assembly with weekly WhatsApp photo updates.' },
];
...
export default async function Template3Contact({ params }: PageProps) {
  ...
  const hours = 'Mon–Sat: 9:30 AM – 7:30 PM (Sunday by appointment)';
  ...
  const contactCards = [
    ...
    ...(phone ? [{ icon: Phone, label: 'Call us directly', value: phone, href: `tel:${phone.replace(/\s/g, '')}` }] : []),
        ...
        <div className="max-w-[1220px] mx-auto grid lg:grid-cols-[1.05fr_0.95fr] gap-11 lg:gap-16 items-start">
          <Reveal>
            ...
            <p className="mt-4.5 max-w-[560px] text-[#6d6259] text-[16px]">
              Tell us about your home and budget. An interior architect from {cleanName || 'our studio'} will connect with you within a few working hours.
            </p>
