...
const CONSULTATION_STEPS = [
  { step: '01', title: 'Private Plot Inquiry', desc: 'Our architectural coordinator reviews your plot dimensions, municipal zone, and spatial vision.' },
  { step: '02', title: 'Atelier & Plot Meeting', desc: 'Meet our principal architect. Review topographical contours, solar angles, and physical material mockups.' },
  { step: '03', title: '3D BIM & Sanction Dossier', desc: 'Review 3D spatial walkthroughs, structural finite-element schemas, and an itemised BOQ.' },
  { step: '04', title: 'Turnkey Civil Handover', desc: 'Monolithic RCC casting, structural steel erection, and final keys handover with a 10-year structural warranty.' },
];

export default async function Template14Contact({ params }: PageProps) {
  ...
  const visitImage =
    ...
    media.otherImages?.[0] ||
    '/images/architecture/atelier-design-studio.webp';
        ...
        <div className="max-w-[1240px] mx-auto px-[30px]">
          <Reveal className="mb-[52px]">
            ...
            <p className="text-[#7a6f60] text-[16px] font-light max-w-[640px]">
              Sit with a licensed architect from {cleanName || 'our studio'} for an unhurried hour — walk through materials, plot plans, and budgets. By private appointment, never a queue.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div className="grid lg:grid-cols-[1.1fr_0.9fr] bg-[#17130f] text-white overflow-hidden shadow-2xl">
              ...
              <div className="px-8 py-12 lg:px-[58px] lg:py-16 flex flex-col justify-center">
                ...
                <VisitForm studioName={cleanName || 'the studio'} waPhone={waPhone} dark={true} />
              </div>
            </div>
          </Reveal>
        </div>
