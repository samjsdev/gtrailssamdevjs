...
const ROOM_NAMES = [
  ...
  'Heat-Proof Clay Brick Home',
  'Independent Family Residence',
  'Double-Height Living Room',
  'Covered Veranda & Garden',
  'Terrace Pergola & Garden',
  'Contemporary Master Suite',
  'Dining & Courtyard Lounge',
];

const CURATED_STUDIES = [
  {
    title: 'Modern Luxury Villa',
    specs: '5,400 sq.ft · 4-BHK Luxury Villa',
  ...
  },
  {
    ...
    specs: '6,800 sq.ft · Independent House',
...
export default async function Template14Gallery({ params }: PageProps) {
        ...
        <div className="max-w-[1240px] mx-auto px-[30px]">
          <Reveal>
            ...
            <p className="text-[#7a6f60] text-[16px] font-light max-w-[640px]">
              {cleanDesc || `Every photograph represents a genuine, delivered private residence in ${city} — browse landmarks we have designed, engineered, and built.`}
            </p>
          </Reveal>
        </div>
      </section>
