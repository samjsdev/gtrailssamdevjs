  ...
  return (
    ...
    >
      ...
      <p className="text-[12.5px] text-[#6b6660] font-semibold mb-4">
        3D BIM designs + itemised civil quote for your plot
      </p>
      ...
      <select
        name="home"
        aria-label="Project typology & scope"
      ...
      >
        <option>Turnkey Villa Construction (G+1 / G+2)</option>
        <option>Independent House / Duplex on Plot</option>
        <option>Architectural Floor Plan &amp; 3D Elevation</option>
        <option>CMDA / GCC Building Sanction Permission</option>
        <option>Structural Design &amp; Geotechnical Soil Testing</option>
        <option>Commercial / Mixed-Use Development</option>
      </select>
      ...
      >
        {sent ? "We'll Call You Shortly" : 'Consult Architects'}
      </button>
      <small className="block text-center mt-3 text-[11px] text-[#6b6660] font-semibold">
        A licensed architect or senior civil engineer will call you back.
      </small>
    </form>
  );
}
