  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-4xl bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <p className="text-gray-500 text-center mb-12">Your data for <strong>{slug}</strong> has been bound to 6 distinct interior templates. Click below to preview them.</p>
