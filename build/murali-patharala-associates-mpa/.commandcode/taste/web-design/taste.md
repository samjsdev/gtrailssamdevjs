...
- Wants site copy to speak directly to the visitor in second-person with a coherent narrative flow across sections in logical order — rejects fragmented, thin/short, choppy third-person "bits and pieces" copy; individual service/detail pages should carry substantive but concise explanatory narrative, broken with headings and images rather than long unbroken text walls. Confidence: 0.85
- Expects service overview pages to include prominent link buttons/CTAs to each individual service detail page, not just static cards. Confidence: 0.8
- When a page gets text-heavy, wants copy trimmed and broken with clear heading/sub-heading hierarchy plus inline images rather than long unbroken paragraphs. Confidence: 0.8
