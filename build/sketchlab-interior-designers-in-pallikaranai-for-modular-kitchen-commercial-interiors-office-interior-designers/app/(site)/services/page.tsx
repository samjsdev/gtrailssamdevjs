          ...
          {[
            {
              ...
              image: "/images/otherImages-37.jpg",
            ...
            },
            {
              ...
              image: "/images/treatmentImages-2.jpg",
          ...
          <div className="lg:col-span-5 flex justify-center w-full">
            <div className="w-full aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-sm border border-[#EAE3D8]/50">
              <img 
                ...
                alt="Navy blue modular kitchen showroom display" 
