...
export function getServiceImage(serviceName: string, media: any): string | null {
  ...
  if (lower.includes("residential") || lower.includes("home")) return "/images/clinicImages-1.jpg";
  if (lower.includes("kitchen")) return "/images/clinicImages-2.jpg";
  if (lower.includes("living") || lower.includes("styling")) return "/images/clinicImages-3.jpg";
  if (lower.includes("bedroom")) return "/images/clinicImages-4.jpg";
  if (lower.includes("space") || lower.includes("planning")) return "/images/treatmentImages-1.jpg";
  if (lower.includes("furniture") || lower.includes("custom")) return "/images/treatmentImages-2.jpg";
  if (lower.includes("commercial") || lower.includes("office")) return "/images/treatmentImages-3.jpg";
  if (lower.includes("lighting")) return "/images/treatmentImages-4.jpg";
