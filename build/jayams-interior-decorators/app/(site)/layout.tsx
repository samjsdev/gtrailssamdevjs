...
export default async function Template5Layout({ children, params }: LayoutProps) {
  ...
  return (
    <div className={`${oswald.variable} ${spaceGrotesk.variable} min-h-screen bg-[#F4F3EE] text-[#252A29] flex flex-col font-sans selection:bg-[#E94B26] selection:text-[#F4F3EE] antialiased`}>
      ...
      <footer className="bg-[#252A29] text-[#F4F3EE] border-t-4 border-[#111111]">
        {/* Top Highlight Banner */}
        <div className="bg-[#181B1A] border-b-2 border-[#111111] py-8 px-4 sm:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="space-y-4">
              ...
              <div className="pt-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#181B1A] text-[#C8A84E] text-[10px] font-bold uppercase tracking-widest border border-[#C8A84E]/40">
            ...
            <div className="space-y-3">
              <h4 className="text-xs font-black uppercase tracking-[0.25em] text-[#C8A84E] border-b-2 border-[#181B1A] pb-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 pb-12">
          <div className="w-full h-64 sm:h-80 border-4 border-[#111111] overflow-hidden shadow-[6px_6px_0px_#111111] bg-[#181B1A] relative">
            <iframe
              ...
              loading="lazy"
            />
            <div className="absolute top-3 left-3 bg-[#252A29]/95 text-[#F4F3EE] px-3.5 py-1.5 border border-[#C8A84E] text-[11px] font-mono font-bold flex items-center gap-2 shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 pb-12 pt-4">
          <div className="border-t-2 border-[#181B1A] pt-6 flex flex-wrap items-center justify-between gap-4 text-[11px] font-mono text-[#F4F3EE]/60">
            <div>
