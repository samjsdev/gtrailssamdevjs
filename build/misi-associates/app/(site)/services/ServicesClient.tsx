    ...
    return (
      <div ref={containerRef} className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-200 selection:text-blue-900 overflow-x-hidden">
        ...
        {(() => {
            ...
            const rImg = data?.services?.renovations?.image || data?.media?.clinicImages?.[9] || '/images/stock/c87d10e5.webp';
                            ...
                            <div className="w-full lg:w-1/2 fade-up">
                                 <div className="relative aspect-[4/3] w-full">
                                    ...
                                    <div className="absolute -bottom-8 -right-8 bg-white p-8 shadow-xl max-w-xs z-20 hidden md:block rounded-xl">
                                        <p className="font-serif italic text-xl text-slate-800 mb-2">"From concept to completion."</p>
                                        <p className="text-xs text-slate-400 uppercase tracking-widest">26 Years • 450+ Projects</p>
                                    </div>
                                 </div>
                            </div>
                            <div className="w-full lg:w-1/2 fade-up">
        ...
        {(() => {
            ...
            const kbImg = data?.services?.kitchenBath?.image || data?.media?.clinicImages?.[10] || '/asset/portfolio/pdf-gallery-6.png';
                ...
                <section className="treatment-section py-32 px-6 bg-slate-900 text-white relative overflow-hidden">
                    ...
                    <div className="max-w-[1400px] mx-auto relative z-10">
                        <div className="grid lg:grid-cols-2 gap-20 items-center">
                            ...
                            <div className="order-1 lg:order-2 fade-up relative aspect-[4/3] w-full grayscale hover:grayscale-0 transition-all duration-1000 rounded-[2.5rem] overflow-hidden">
                                 <Image 
                                    src={kbImg} 
                                    alt={kbTitle} 
                                    fill 
        ...
        {(() => {
            ...
            const comImg = data?.services?.commercial?.image || data?.media?.clinicImages?.[11] || '/images/stock/df95fb87.webp';
        ...
        {(() => {
            ...
            const advImg1 = data?.services?.advanced?.images?.[0] || data?.media?.clinicImages?.[12] || '/images/stock/7d1751fd.webp';
            const advImg2 = data?.services?.advanced?.images?.[1] || data?.media?.clinicImages?.[13] || '/images/stock/e4c85f7e.webp';
        ...
        {(() => {
            ...
            const btnAppt = data?.cta?.buttonText || 'Start a Consultation';
