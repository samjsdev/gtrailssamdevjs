...
export default function AboutPage() {
    ...
    const founderProfileLabel = data?.doctor?.profileLabel || 'Studio Profile';
    ...
    const founderEducation = data?.doctor?.capabilities || data?.doctor?.education || [
        'B.Arch - Prestigious Architecture College',
        'M.Des - Institute of Design Studies'
    ];
    const founderCapabilitiesLabel = data?.doctor?.capabilitiesLabel || 'Capabilities';
    const founderPhilosophy = data?.doctor?.philosophy || 'Clear communication, thoughtful design, and accountable delivery.';
    const founderImage = data?.doctor?.images?.[0] || data?.media?.otherImages?.[0] || '/images/stock/bbb7f0e7.webp';
    ...
    const teamImages = data?.about?.team?.images || [
                ...
                <section className="py-24 bg-[var(--surface)] relative overflow-hidden mb-32">
                    ...
                    <div className="max-w-[1240px] mx-auto px-6 relative z-10">
                        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
                            ...
                            <div className="philosophy-grid lg:col-span-8 grid sm:grid-cols-2 gap-4">
                                {philosophyPrinciples.map((item: any) => (
                                    <div key={item.id} className="philosophy-item group p-8 rounded-[2rem] bg-[var(--bg)] border border-[var(--border)] hover:border-[var(--accent)]/40 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="max-w-[1240px] mx-auto">
                        <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-12 lg:gap-20 items-center">
                            ...
                            <div className="founder-img relative group">
                                ...
                                <div className="relative aspect-[4/3] rounded-[40px] overflow-hidden shadow-2xl bg-white">
                                    <Image
                                        src={founderImage}
                                        alt={founderName}
                                        fill
                                ...
                                <div className="absolute bottom-10 -right-6 md:-right-10 bg-[var(--surface)] p-6 rounded-2xl shadow-xl border border-[var(--border)] max-w-[200px] backdrop-blur-sm hidden md:block">
                                    ...
                                    <p className="relative z-10 text-sm italic text-[var(--muted)] pt-6 text-center">
                                        One coordinated team, accountable through handover.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="founder-content flex flex-col">
                                <span className="font-mono text-xs text-[var(--accent)] tracking-[0.2em] uppercase mb-4">{founderProfileLabel}</span>
