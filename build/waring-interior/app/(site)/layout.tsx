    ...
    <div className={`${inter.className} min-h-screen bg-stone-50 text-stone-900 selection:bg-stone-200 scroll-smooth flex flex-col`}>
      <SmoothScrollProvider>
        ...
        <div className="flex flex-col items-center gap-4 mb-4">
          <img src={`${basePath || ''}/waringlogo.webp`} alt={clinic.name || "Studio Logo"} className="h-20 w-auto object-contain rounded-full border border-stone-800" />
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-10 mb-12 text-[11px] uppercase tracking-[0.2em] font-medium text-stone-400">
          ...
          <Link href={`${basePath}/privacy`} className="hover:text-white transition-colors">Privacy</Link>
          <Link href={`${basePath}/terms`} className="hover:text-white transition-colors">Terms</Link>
        </div>
