...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: desc,
    keywords: [
      "About Waring Interior",
      "Ashley Interior Designer",
      "Biophilic Design",
...
export default async function AboutPage({ params }: PageProps) {
  ...
  const principalImage = "/clinicImages-2.jpg";
  ...
  const aboutHeroImage = "/images/waring/waring-interior-22.webp";

  const founderName = doctor?.name || 'Ashley';
