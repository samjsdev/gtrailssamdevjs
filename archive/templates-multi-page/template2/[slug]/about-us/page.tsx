            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-4xl md:text-5xl lg:text-6xl font-normal text-blue-900 leading-none tracking-tighter -mt-1">{clinic.name || 'Our Studio'}</h4>
                </div>
              </div>
            ...
            <div className="flex-1 w-full order-2 lg:order-1">
              <div className="relative rounded-3xl overflow-hidden bg-gray-100">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 bg-white rounded-2xl p-6 shadow-xl border border-gray-100 text-center">
                    <h4 className="text-xl font-medium text-blue-900">{doctor.name || 'Our Lead Designer'}</h4>
            ...
            <div className="flex-1 order-1 lg:order-2 lg:pt-10 space-y-10">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-blue-900 leading-none tracking-tighter -mt-1.5">Designer</h4>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="text-center mb-20 space-y-5">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-5xl md:text-6xl font-normal text-blue-900 leading-none tracking-tighter -mt-1">For Every Detail</h4>
            </div>
