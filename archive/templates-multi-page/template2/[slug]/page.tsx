    ...
    <div className="font-sans text-blue-900 bg-gray-50 min-h-screen selection:bg-blue-900 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="mb-20 space-y-5">
            ...
            <div className="flex flex-col">
              ...
              <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-blue-900 leading-none tracking-tighter -mt-1.5">Your Life</h4>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
            <div className="space-y-5 flex-1">
              ...
              <div className="flex flex-col">
                ...
                <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-blue-900 leading-none tracking-tighter -mt-1.5">Services</h4>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
            <div className="space-y-5 flex-1">
              ...
              <div className="flex flex-col">
                <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-gray-500 leading-none tracking-tighter">Spaces With</h4>
                <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-white leading-none tracking-tighter -mt-1.5">Character</h4>
              </div>
           ...
           <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
             <div className="order-2 lg:order-1 relative">
                ...
                <div className="absolute -bottom-8 -right-4 md:right-8 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-6">
                   <div>
                     <h4 className="text-xl font-medium text-blue-900">{doctor.name || 'Lead Designer'}</h4>
             ...
             <div className="order-1 lg:order-2 space-y-12">
               <div className="space-y-5">
                 ...
                 <div className="flex flex-col">
                   ...
                   <h4 className="text-5xl lg:text-7xl font-normal text-blue-900 leading-none tracking-tighter -mt-1.5">Designers</h4>
                 </div>
                ...
                <div className="space-y-8">
                  <div className="flex gap-5 group">
                    ...
                    <div>
                      <h5 className="text-lg font-medium text-blue-900">Space Planners</h5>
                  ...
                  <div className="flex gap-5 group">
                    ...
                    <div>
                      <h5 className="text-lg font-medium text-blue-900">Material & Lighting Leads</h5>
                  ...
                  <div className="flex gap-5 group">
                    ...
                    <div>
                      <h5 className="text-lg font-medium text-blue-900">Execution Coordinators</h5>
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="mb-20 space-y-5 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-blue-900 leading-none tracking-tighter -mt-1.5">Happy Clients</h4>
            </div>
              ...
              {displayReviews.map((review: any, i: number) => (
                <div key={i} className="bg-white p-10 rounded-3xl border border-gray-100 flex flex-col h-full hover:shadow-lg hover:border-gray-300 transition-all duration-300">
                   ...
                   <div className="flex items-center gap-4 mt-auto border-t border-gray-100 pt-6">
                      ...
                      <div>
                        <h6 className="font-semibold text-sm text-blue-900 uppercase tracking-wider">{review.author || 'Client'}</h6>
                      </div>
                   </div>
                </div>
              ))}
      ...
      <section className="py-24 lg:py-40 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center w-full">
            <h3 className="text-5xl md:text-6xl lg:text-7xl font-normal text-gray-500 leading-none tracking-tighter mb-4">Your Design Journey</h3>
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-12">Bring your space closer to the way you want to live. Book a consultation and let us shape a clear design path forward.</p>
