    ...
    <div className="font-sans text-blue-900 bg-gray-50 min-h-screen selection:bg-blue-900 selection:text-white">
      ...
      <section className="py-20 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-8 text-center space-y-6">
          <h3 className="text-2xl md:text-3xl font-normal text-blue-900 tracking-tight">See How Thoughtful Interior Design Changes a Space</h3>
              ...
              <div key={idx} className="bg-white rounded-3xl border border-gray-100 cursor-pointer group flex flex-col h-full hover:shadow-lg hover:border-gray-200 transition-all duration-300">
                ...
                <div className="p-8 grow flex flex-col">
                  ...
                  <div className="mt-8 flex justify-between items-center pt-6 border-t border-gray-50">
                     <span className="text-xs font-semibold text-blue-900 uppercase tracking-widest group-hover:text-gray-500 transition-colors">View Project</span>
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                   ...
                   <h4 className="text-4xl md:text-5xl lg:text-6xl font-normal text-blue-900 leading-none tracking-tighter -mt-1">Inside Studio Spaces</h4>
                </div>
              </div>
