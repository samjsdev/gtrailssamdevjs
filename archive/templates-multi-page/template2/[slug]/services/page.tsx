    ...
    <div className="font-sans text-blue-900 bg-gray-50 min-h-screen selection:bg-blue-900 selection:text-white">
      ...
      <section className="bg-gray-100 border-b border-gray-200 py-10">
        <div className="max-w-7xl mx-auto px-8 w-full grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div><span className="text-3xl font-normal text-blue-900">{servicesList.length}+</span><p className="text-gray-500 text-[11px] font-semibold tracking-widest uppercase mt-2">Design Services</p></div>
          ...
          <div><span className="text-3xl font-normal text-blue-900">100%</span><p className="text-gray-500 text-[11px] font-semibold tracking-widest uppercase mt-2">Material Standards</p></div>
          <div><span className="text-3xl font-normal text-blue-900">Turnkey</span><p className="text-gray-500 text-[11px] font-semibold tracking-widest uppercase mt-2">Execution Support</p></div>
        </div>
      </section>
