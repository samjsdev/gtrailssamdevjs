...
import { 
  MapPin, Phone, Mail, Clock, Send, MessageSquare, Navigation
} from 'lucide-react';
      ...
      <section className="relative text-white py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          ...
          <div className="flex flex-col mb-8">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-normal text-white leading-none tracking-tighter -mt-1.5">Plan Your Space</h2>
          </div>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div>
                    <h4 className="font-medium text-emerald-900 mb-2">Studio Address</h4>
                    <p className="text-gray-600 font-light leading-relaxed text-sm">{clinic.address?.full || 'Complete studio address will appear here once configured.'}</p>
                ...
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-light text-sm">Consultations & General Enquiries:</p>
                    ...
                    <p className="text-gray-500 font-light text-[13px] mt-3 leading-relaxed">For urgent project or site coordination, call the same number for guidance.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-light text-sm">For project references, documents, or non-urgent queries:</p>
            ...
            <div className="lg:col-span-3">
              <div className="bg-gray-50 p-8 lg:p-12 rounded-3xl border border-gray-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-2xl font-normal text-emerald-900 tracking-tight">Book a Design Consultation</h3>
                </div>
                <p className="text-gray-500 font-light mb-10 text-sm">Fill in your details and we will get back to you within 2 business hours to confirm your consultation.</p>
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea rows={4} className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-emerald-900 transition-all bg-white placeholder:text-gray-300 text-sm resize-none" placeholder="Tell us about your rooms, budget, timeline, or design goals..."></textarea>
                  </div>
      ...
      <section className="py-24 lg:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="text-center mb-20 space-y-5">
            <h3 className="text-sm font-semibold text-gray-500 tracking-[0.15em] uppercase">Your First Consultation</h3>
            <div className="flex flex-col items-center">
              <h4 className="text-5xl md:text-6xl font-normal text-gray-400 leading-none tracking-tighter">What to Expect</h4>
              <h4 className="text-5xl md:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1">When We Meet</h4>
            </div>
            <p className="text-lg text-gray-500 font-light pt-2">We keep the first conversation clear, useful, and easy to act on.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            <div className="flex-1 space-y-8">
              ...
              <div className="space-y-6 text-gray-600 text-[16px] leading-relaxed font-light">
                <p>
                  We are conveniently located at <strong className="text-emerald-900 font-medium">{clinic.address?.full || 'a centrally accessible location'}</strong>. Our studio is easily reachable by public transport, auto-rickshaw, or private vehicle.
                </p>
                <p>
