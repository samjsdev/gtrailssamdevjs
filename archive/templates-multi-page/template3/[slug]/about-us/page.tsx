    ...
    <div className="font-sans text-emerald-900 bg-gray-50 min-h-screen selection:bg-emerald-900 selection:text-white">
      ...
      <section className="relative text-white py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 w-full relative z-10">
          ...
          <div className="flex flex-col mb-8">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-normal text-white leading-none tracking-tighter -mt-1.5">Your Design Studio</h2>
          </div>
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-4xl md:text-5xl lg:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1">{clinic.name || 'Our Studio'}</h4>
                </div>
              </div>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="mb-20 space-y-5 text-center">
            ...
            <p className="text-lg text-gray-500 font-light pt-2 max-w-2xl mx-auto">Every decision we make — from the first layout option to the final styling detail — is guided by these six principles.</p>
          </div>
            ...
            <div className="flex-1 w-full order-2 lg:order-1">
              <div className="relative rounded-3xl overflow-hidden bg-gray-100">
                 ...
                 <div className="absolute bottom-6 left-6 right-6 bg-white rounded-2xl p-6 shadow-xl border border-gray-100 text-center">
                    <h4 className="text-xl font-medium text-emerald-900">{doctor.name || 'Our Lead Designer'}</h4>
                    <p className="text-gray-500 font-semibold mt-1 text-xs tracking-widest uppercase">{doctor.specialization || 'Interior Design & Turnkey Execution'} • {doctor.experience || '10+ Years'}</p>
                 </div>
              </div>
            </div>
            ...
            <div className="flex-1 order-1 lg:order-2 lg:pt-10 space-y-10">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1.5">Designer</h4>
                </div>
              </div>
      ...
      <section className="py-24 lg:py-32 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="text-center mb-20 space-y-5">
            <h3 className="text-gray-500 font-semibold tracking-[0.15em] uppercase text-xs">Our Design Disciplines</h3>
            <div className="flex flex-col items-center">
              <h4 className="text-5xl md:text-6xl font-normal text-gray-400 leading-none tracking-tighter">A Design Team</h4>
              <h4 className="text-5xl md:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1">For Every Detail</h4>
            </div>
            <p className="text-gray-500 font-light text-lg pt-2 max-w-2xl mx-auto">Our multi-disciplinary team collaborates to deliver coordinated interior design, material selection, and execution support under one roof.</p>
          </div>
      ...
      <section className="bg-emerald-900 py-24 lg:py-40 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center w-full">
          ...
          <p className="text-xl text-gray-400 font-light mb-12 max-w-2xl mx-auto">Visit the studio, meet the team, and let us show you how thoughtful planning can change the way your space feels.</p>
